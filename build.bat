...
clang src/main.cpp src/GPUTimer.cpp src/GLProgram.cpp %IMGUI% lib/glad/glad.c -o einherjarEngine.exe -Lfolder -lglad -lglfw3 -Ilib -Ilib/imgui -Ilib/imgui/backends -Ilib/glfw3
