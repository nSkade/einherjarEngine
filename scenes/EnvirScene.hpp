...
public:
	...
	//	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, m_windowRes.x, m_windowRes.y, 0, GL_RGB, GL_UNSIGNED_BYTE, NULL);
	...
	//	glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, m_windowRes.x, m_windowRes.y, 0, GL_DEPTH_COMPONENT, GL_UNSIGNED_BYTE, NULL);
	...
	//	glFrontFace(GL_CW);
		...
		//	glBlitNamedFramebuffer(m_fbo,0,0,0,m_windowRes.x,m_windowRes.y,0,0,m_windowRes.x,m_windowRes.y,GL_COLOR_BUFFER_BIT,GL_NEAREST);
