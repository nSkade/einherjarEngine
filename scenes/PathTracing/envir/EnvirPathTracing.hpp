...
public:
	...
	int run() {
		...
		//sponza.load("D:/Download/ehjE/SunTemple_v4/SunTemple/gltf/Untitled.gltf");
		...
		auto glpRTbuild = [&]() -> bool {
			...
			//bool r= glpRT.addSourceFromFileRecursive(EHJ_THIS_FOLDER()+"bvhPTimp.comp");
			bool r= glpRT.addSourceFromFileRecursive(EHJ_THIS_FOLDER()+"bvhPT.comp");
			glpRT.createProgram();
			return r;
		}; glpRTbuild();
