...
#include "scenes/EnvirTexScene/brdf inl/LightDef.glsl"
#include "scenes/EnvirTexScene/brdf inl/BRDFcookTorrence.glsl"
#include "scenes/EnvirTexScene/brdf inl/blinnPhong.glsl"
...
void main() {
	...
	color.xyz = texture(u_albedo,uvV).xyz;
	//color = vec4(n,1.);
};
